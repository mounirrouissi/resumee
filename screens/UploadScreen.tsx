        ...
        >
          ...
          >
            ...
            >
              ...
              <ThemedText style={[Typography.h3, { marginTop: Spacing.lg }]}>
                Upload Your Resume
              </ThemedText>
              <ThemedText
                style={[
              ...
              {[
                {
                  ...
                  icon: "upload",
                  title: "Upload",
                  desc: "Select your resume PDF",
                },
                {
                  step: 2,
                  icon: "cpu",
                  title: "AI Enhancement",
                  desc: "Our AI improves your content",
                },
                {
                  step: 3,
                  icon: "download",
                  title: "Download",
                  desc: "Get your polished resume",
                },
              ].map((item) => (
                <View
                  key={item.step}
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                Rate us on the store to help us improve!
              </ThemedText>
            </View>
            <Feather
              name="chevron-right"
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <ThemedText style={[Typography.h2, { marginTop: Spacing.lg }]}>
              Processing Resume
            </ThemedText>
          ...
          <ScrollView contentContainerStyle={styles.previewModalContent}>
            ...
            >
              {templates.find((t) => t.id === selectedTemplate)?.description ||
                "A professional, ATS-optimized template suitable for most industries."}
            </ThemedText>
            <Pressable
              style={[
                styles.processButton,
